<?php	
	...
	***********************************************/
	...
	function arch_script_styles_reg () {
		...
		if(is_page_template('template-contact.php')) {
			...
			add_action( 'wp_head', 'arch_google_map' );
		}
	...
	***********************************************/
	...
	function arch_google_map() {
		...
		$arch_map_zoom = get_option('arch_map_zoom');
		?>
			    ...
			    $(document).ready(function(){
			    	map = new GMaps({
				        ...
				        lat: <?php if($lat == "") { echo "-12.043333"; }else { echo $lat; } ?>,
							...
							zoom: <?php if($arch_map_zoom!="") : echo $arch_map_zoom; else : echo "8"; endif ?>
			      	});
			      	map.addMarker({
				        lat: <?php if($lat == "") { echo "-12.043333"; }else { echo $lat; } ?>,
							lng: <?php if($lng == "") { echo "-77.028333"; }else { echo $lng; } ?>,
